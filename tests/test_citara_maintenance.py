...
SCRIPT_PATH = Path(__file__).resolve().parents[1] / "scripts" / "citara_maintenance.py"
spec = importlib.util.spec_from_file_location("citara_maintenance", SCRIPT_PATH)
citara_maintenance = importlib.util.module_from_spec(spec)
assert spec and spec.loader
spec.loader.exec_module(citara_maintenance)
